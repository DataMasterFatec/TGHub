...
US01. **Levantar requisitos funcionais e não funcionais**  
   - Saída: lista documentada de requisitos.  

US02. **Mapear usuários e criar personas**  
   - Saída: personas definidas.  

US03. **Definir objetivos principais do sistema/produto**  
   - Saída: documento de objetivos aprovado pelo PO.  

US04. **Criar fluxos de navegação macro**  
   - Saída: fluxograma de alto nível das interações.  

US05. **Criar wireframes de baixa fidelidade para telas principais**  
   - Saída: wireframes iniciais (rascunho digital).  

US06. **Validar wireframes com stakeholders**  
   - Saída: feedback registrado em ata/documento.

US07. **Modelagem conceitual do banco de dados**  
   - Saída: material para auxiliar a construão do banco de dados.  
 
US08. **Documentar requisitos funcionais iniciais**  
...
|------|--------|--------|--------|
| US01 | Levantar requisitos funcionais e não funcionais |Must | in progress |
| US02 | Mapear usuários e criar personas | Must | To do |
| US03 | Definir objetivos principais do sistema/produto | Must | To do |
| US04 | Criar fluxos de navegação macro | Must | To do |
| US05 | Criar wireframes de baixa fidelidade | Must | To do |
| US06 | Validar wireframes com stakeholders | Should | To do |
| US07 | Modelagem conceitual do Banco de dados | Should | To do |
| US08 | Documentar requisitos funcionais iniciais | Could | To do |
